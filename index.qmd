...
- Fall 2026: Ph.D. in Computer Science, University of Illinois Chicago (UIC)
...
::: {.pub-meta}
[ACL 2026 Main]{.pub-badge .pub-badge-accepted} [Second author]{.pub-role}
:::
:::
...
::: {.pub-meta}
[ICML 2026 Main]{.pub-badge .pub-badge-accepted} [Sixth author]{.pub-role}
:::
:::
:::
...
- **CoEvoDoc** — first-author collaboration with Prof. Lu Cheng (UIC)
  on a co‑evolving repository documentation system for coding agents
  that adapts structure complexity to project change magnitude.
